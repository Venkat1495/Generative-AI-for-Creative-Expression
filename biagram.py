...
batch_size = 4 # how many independent squences can be processed parallel?
block_size = 8 # what is the max contest lenght or predections ?
max_iters = 3000
eval_interval = 300
learning_rate = 1e-2
...
class BigramLanguageModel(nn.Module):
    ...
    def generate(self, idx, max_new_tokens):
        ...
        for _ in range(max_new_tokens):
            # get the predictions
            logits, loss = self(idx)  # calls forward funtions
